...
<body>
    <div class="main">
        <div class="box">
            <div class="header">
                <img src="../File/Henil.ico" alt="not load">
                <div class="h-data">
                    <a href="https://henilcodes.github.io/PH/" class="logo_name">Henil Codes</a>
                    <h5>Welcome back!</h5>
                </div>
            </div>
            <div class="infor">
                <form autocomplete="off" action="../File/UserLog_phcode.php" method="post">
                    <div class="input_box">
            ...
            <div class="box1_bottm">
                <span class="crea">Don't have an account?</span> <a href="../SignUp/" class="sign_up"> Sign up</a>
            </div>
        </div>
        <div class="Footer">
...
<script src="../File/valid.js"></script>
</html>